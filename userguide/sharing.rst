...
.. table:: SMB Share Options
   ...
   |                                |               |          |                                                                                                                                                      |
   +--------------------------------+---------------+----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Enable Shadow Copies           | checkbox      | ✓        | Expose ZFS snapshots as `Windows Shadow Copies <https://en.wikipedia.org/wiki/Shadow_Copy>`__                                                        |
   |                                |               |          | for Volume Shadow Copies Service (VSS) clients.                                                                                                      |
   |                                |               |          |                                                                                                                                                      |
   +--------------------------------+---------------+----------+------------------------------------------------------------------------------------------------------------------------------------------------------+
