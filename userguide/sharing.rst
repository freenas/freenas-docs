...
.. table:: WebDAV Share Options
   ...
   |                        |             |                                                                                   |
   +------------------------+-------------+-----------------------------------------------------------------------------------+
   | Path                   | browse      | Enter the path or :guilabel:`Browse` to the volume/dataset to share. Appending a  |
   |                        | button      | new name to the path will create a new dataset. Example:                          |
   |                        |             | :file:`/mnt/vol1/newdataset`.                                                     |
   +------------------------+-------------+-----------------------------------------------------------------------------------+
