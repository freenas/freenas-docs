...
Refer to the guide included with the %brand% Storage Array for detailed
instructions on how to configure out-of-band management settings. Ensure
the %brand% system out-of-band management port is connected to an
appropriate network.
