...
.. figure:: %imgpath%/installer-boot-menu.png
...
.. figure:: %imgpath%/installer-install-menu.png
...
.. figure:: %imgpath%/installer-drive.png
...
.. figure:: %imgpath%/installer-drive-warning.png
...
.. figure:: %imgpath%/installer-upgrade-or-fresh-install.png
...
.. figure:: %imgpath%/installer-root-password.png
...
.. figure:: %imgpath%/installer-boot-mode.png
...
.. figure:: %imgpath%/installer-complete.png
...
.. figure:: %imgpath%/installer-upgrade-method.png
...
.. figure:: %imgpath%/installer-upgrade-preserved-database.png
...
.. figure:: %imgpath%/boot-menu-environments.png
...
.. figure:: %imgpath%/virtualbox-create-name-os.png
...
.. figure:: %imgpath%/virtualbox-create-memory.png
...
.. figure:: %imgpath%/virtualbox-create-hard-drive.png
...
.. figure:: %imgpath%/virtualbox-create-hard-drive-file-type.png
...
.. figure:: %imgpath%/virtualbox-create-storage-type.png
...
.. figure:: %imgpath%/virtualbox-create-disk-filename-size.png
...
.. figure:: %imgpath%/virtualbox-new-vm.png
...
.. figure:: %imgpath%/virtualbox-vm-settings-storage.png
...
.. figure:: %imgpath%/virtualbox-vm-settings-storage-add-iso.png
...
.. figure:: %imgpath%/virtualbox-vm-settings-network-bridged.png
...
#. **Select creation type**: Select
   ...
   .. figure:: %imgpath%/esxi_create_type.png
...
#. **Select a name and guest OS**: Enter a name for the VM. Leave ESXi
   ...
   .. figure:: %imgpath%/esxi_name_os.png
...
#. **Select storage**: Select a datastore for the VM. The datastore
   ...
   .. figure:: %imgpath%/esxi_select_storage.png
...
#. **Customize settings**: Enter the recommended minimums of at least
   *8 GiB* of memory and *32 GiB* of storage. Select
   ...
   .. figure:: %imgpath%/esxi_custom_settings.png
...
#. **Ready to complete**: Review the VM settings. Click
   ...
   .. figure:: %imgpath%/esxi_ready_complete.png
...
.. figure:: %imgpath%/esxi-add-disk.png
