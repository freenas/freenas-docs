...
:numref:`Figure %s <global_cifs_config_fig>`
shows the global CIFS configuration options which are
described in
:numref:`Table %s <global_cifs_config_opts_tab>`.
