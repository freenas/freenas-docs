...
Once you have finished completing the fields, click :guilabel:`Submit`
to automatically generate and upload the report to
...
pop-up window provides a clickable URL to view the ticket status or
