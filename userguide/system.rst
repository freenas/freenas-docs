...
.. table:: Cloud Credential Options
   ...
   |                                             |                      | through *My Account --> Security Credentials --> Access Keys*. Must only contain alphanumeric characters  |
   ...
   |                                             |                      | *My Account --> Security Credentials --> Access Keys* and create a new key pair. Must only contain        |
   |                                             |                      | alphanumeric characters and must be between 8 and 40 characters.                                          |
   +---------------------------------------------+----------------------+-----------------------------------------------------------------------------------------------------------+
