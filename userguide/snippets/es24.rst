...
Plug one end of the SAS cable into the SAS 0 connector on the ES24
expansion module 1. Plug the other end into the SAS 1 connector on
the Z series node 1. See cable #1 in
:numref:`Figure %s <es24_sasconnect1>`.

If the Z series has a second node for HA (High Availability), plug one
end of the second SAS cable into the T1 connector of the ES24's
expansion module 2. Plug the other end into the SAS 1 connector on the
Z series node 2. See cable #2 in
:numref:`Figure %s <es24_sasconnect1>`.
...
.. table::
   ...
   +------------------------------------------------------------------------+
   | Second ES24 expansion module 1 connector T1 to Z series node 1, SAS 2. |
   +------------------------------------------------------------------------+
   | Second ES24 expansion module 2 connector T2 to Z series node 2, SAS 2. |
   +------------------------------------------------------------------------+
