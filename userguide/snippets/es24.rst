...
The back of the ES24 has redundant power supplies (**#1**) and fans
(**#2** and **#3**). There are also two expansion controllers (**#8**
and **#9**) with three HD Mini SAS3 connectors (**#4**, **#5**, and
**#6**) and a serial port (**#7**).
