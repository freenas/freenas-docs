...
holes on the CMA chassi bracket with the posts on the chassis. Slide
...
The tabs of the flex housing can be unclipped from the top, the
bottom, or both. Route and secure the power cords and other cables,
including SAS cables, through the cable-management arm. Remember to
leave some slack in the cables at both ends to allow for movement.
