...
Shut down and power off the %brand% Unified Array. Remove the %brand%
Unified Array power cables from the power outlets.
...
node for HA (High Availability), connect a second SAS cable from the
ES60 expander module 2 connector 1 to the X20 node 2 SAS 1 connector
(cable #2 in photo).
...
Connecting the ES60 to a %brand% Z Series
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Connect an SAS cable from the ES60 expander module 1 connector 1 to
the Z series Controller 1 SAS 1 connector (cable #1 in photo). If the
Z series has a second node for HA (High Availability), connect a
second SAS cable from the ES60 expander module 2 connector 1 to the
Z series Controller 2 SAS 1 connector (cable #2 in photo).
...
A second ES60 can also be connected to the Z series. Connect the first
