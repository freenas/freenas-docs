...
Drive trays are used to mount drives in the array. These trays have
two status lights for drives: green and amber. The drive tray light is
solid green when a drive is connected, solid amber if there is an issue
or fault with the drive, or solid green with the amber light blinking
when the drive is designated as a hot spare.
