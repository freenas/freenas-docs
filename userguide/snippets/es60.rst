...
the two tabs closest to the end, allowin the flex housing to compress
...
Route power and data cables through the flex housing. The tabs can be
opened or removed to allow access or space for cable ends. Remember to
