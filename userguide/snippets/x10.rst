...
* Accessory kit with power cords, cage nut remover, and mounting
  hardware
...
back panel of each X10 node, #11 on
:numref:`Figure %s <x10_back>`.
...
:ref:`X10_Serial_Port_Device_Names` for the serial device name.
Set the terminal software to:
