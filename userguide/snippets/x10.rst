...
.. table::
   ...
   |                                            |                                            |
   | Set of rails (Caution: the rails have a    | Up to 12 populated drive trays (Caution:   |
   | specific front end, identified by a        | Unused drive bays must be populated with   |
   | label on the outside. The label is         | drive tray blanks to maintain proper       |
   | visible on the right in the photo above.   | airflow for cooling.)                      |
   | During installation, the front ends of     |                                            |
   | the rails must be toward the front of      |                                            |
   | the rack.)                                 |                                            |
   +--------------------------------------------+--------------------------------------------+
...
.. table::
   ...
   +-------------------------------------------------+-------------------------------------------------+
   | 3: USB memory stick (reserved for               | 9: PCIe mezzanine expansion port                |
   | %brand% use)                                    |                                                 |
   +-------------------------------------------------+-------------------------------------------------+
