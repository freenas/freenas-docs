...
.. table::
   ...
   |                                            |                                            |
   | Set of rails (The rails have a specific    | Up to 12 populated drive trays (Note:      |
   | front end, identified by a label on the    | Unused drive bays must be populated with   |
   | outside, visible on the right above.       | drive tray blanks to maintain proper       |
   | During installation, the front ends of the | airflow for cooling.)                      |
   | rails must be toward the front of the      |                                            |
   | rack.)                                     |                                            |
   +--------------------------------------------+--------------------------------------------+
