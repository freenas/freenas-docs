...
:numref:`Figure %s <viewing_disks_fig>`, the current
configuration of each disk is displayed. This table is adjustable
by setting the different column checkboxes above it. Set
