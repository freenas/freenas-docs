...
.. table:: Active Directory Configuration Options
   ...
   #ifdef truenas
   +--------------------------+---------------+----------+-------------------------------------------------------------------------------------------------------------------------------+
   | NetBIOS Name             | string        | ✓        | Automatically populated with the active |ctrlr-term| hostname from the :ref:`Global Configuration`. Limited to 15             |
   |                          |               |          | characters. It **must** be different from the *Workgroup* name.                                                               |
   +--------------------------+---------------+----------+-------------------------------------------------------------------------------------------------------------------------------+
   | NetBIOS Name             | string        | ✓        | Automatically populated with the standby |ctrlr-term| hostname from the :ref:`Global Configuration`. Limited to 15            |
   | (|Ctrlr-term-1-2|)       |               |          | characters. When using :ref:`Failover`, set a unique NetBIOS name for the standby |ctrlr-term|.                               |
   +--------------------------+---------------+----------+-------------------------------------------------------------------------------------------------------------------------------+
